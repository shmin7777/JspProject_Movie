...
%>
    ...
    %>
        ...
        <h1>상영예정작 수정</h1>
        <form enctype="multipart/form-data" method="post" action="manageUpdateMovieAfterAction.jsp" name="insertMovie">
            <table border="1" width="700">
                ...
                <tr>
              	...
              	<tr>
              		...
              		<input type="button" value="수정" onclick="insertMovieCheck1()"></td>
            </table>
        </form>
    </div>
    <%			
