...
<script>
  $(document).ready(function(){
      ...
      <div class="container">
	      ...
	      <img class="brr" src="images/gr02.png" width="1000px" style="border:2px solid darkgrey;">
	      <div align=center style="position: relative;">
	      <input type="button" value="쿠폰 받기" class="button button1" onclick="location.href='eventDetailAction.jsp?e_name=grade'">
	      </div>
	      </div>
      </div>
