      ...
      $('.close_b').click(function(){
        $('.all_menu').removeClass('on');
					...
					<div class="location">
						...
						<a href="snackDetail.jsp">
							스낵 구매
												...
												<img alt="" src="images/bg-location.png" style="margin: 0 10px;">
						<a href="reserveDirectSnackPay.jsp">
							결제하기
						</a>
			...
			<div style="text-align: left;"><h2>상품결제 </h2></div><br>
         	...
         	<form method="post" action="reserveDirectSnackPayAction.jsp" name="reserveSnack">
			...
			<script>
                   ...
                   <div class="reservePayForm">
                   		...
                   		<div>
                   			...
                   			<div class="content open1" >MY 할인쿠폰	<span id="coupon"><%=coupon %></span>개
                   			  ...
                   			  <input type="button" value="-" onclick="minus();" id="cminus" style="padding:5px 6px;"> <span style="font-size: 14px;/*  color: blue; */">* 쿠폰은 한 장당 5000원 입니다.</span>
                   			 </div>
                   		...
                   		<div>
                   			...
                   			<div class="content open2">보유 포인트 <span id="point"><%=point %></span>원  &nbsp;&nbsp;&nbsp;&nbsp;
	                   			사용할 포인트 <input type="text" value="0" name="point2" onchange="usePoint('<%=coupon %>','<%=amount-minusPrice %>');" id="useP">원  
	                   			<input type="button" value="다시입력"  class="resetInput" onclick="restartPoint('<%=coupon%>','<%=amount-minusPrice %>');">
                   			</div> 
                   ...
                   <div class="reservePayment" style="font-size: 20px;">
                   		<div class="reservePayment1">
                   			...
                   			<div class="reservePayment1_2"><span id="oPrice" ><%=amount%></span> 원</div>
                   		</div>
                   		<div class="reservePayment1">
                   			<div class="reservePayment1_1">총 할인금액</div>
                   			<div class="reservePayment1_4"><span id="totalMinus"><%=amount-minusPrice %></span>원</div>
                   		</div>
                   		<div class="reservePayment1">
                  ...
                  <!--  <div style="clear: both;"></div> -->
                   ...
                   <input type="hidden" name="snackQty" value="<%=snackQty %>">
                   	<input type="button" value="결제하기" onclick="checkReserveValue();" class="btnReserveGo3">
                   </div>
        	<% 	
			}catch(Exception e){
				e.printStackTrace();
