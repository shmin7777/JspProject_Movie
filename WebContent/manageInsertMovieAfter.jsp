...
%>
    ...
    <div class="movieInsert">
        <h1>상영 예정작등록</h1>
        <form enctype="multipart/form-data" method="post" action="manageInsertMovieAfterAction.jsp" name="insertMovie">
            <table border="1" width="700">
                ...
                <tr>
              	...
              	<tr>
              		<td colspan="2" width="100px"><input type="button" value="등록" onclick="insertMovieCheck1()"></td>
            </table>
        </form>
    </div>
</body>
