...
<script>
  $(document).ready(function(){
	...
	<%
		...
		String sql ="select * from onebyone where no=?";
	...
	%>
      ...
      <hr style="border: solid 1px lightgray;"><br>
      		...
      		<table class="tbl_form" cellspacing="0" width="1400px" style="margin-bottom: 0px;">
      			<tr>
      				<td style="width:20%;">제목&nbsp;&nbsp;</td>
      				<td style="width:80%;">
      				<input type="text" value="<%=rs.getString(3) %>" readonly="readonly" style="width: 100%;background-color: #F8F8F8;border-color: #DDD; padding: 10px 0">
      				</td>
      			</tr>
      			<tr>
      				<td>내용&nbsp;&nbsp;</td>
      				<td style="line-height: 5px;height: 5px;border:1px solid #000; padding: 0;">
      				
      				<div name="content" maxlength="2048" style="text-align:left; background-color: #F8F8F8;border-color:#DDD;padding: 10px;">
      					<%=rs.getString(4) %>
      					
      					<%if(rs.getString(5)!=null){ %>
      					<br><br><br><img src="custom/<%=rs.getString(5) %>" width="400px">
      					<%} %>
      				</div>
      				</td>
      			</tr>
    ...
    %>
    <div>
    <table class="tbl_form" cellspacing="0" width="1400px" border="1" style="margin: auto;margin-top: 25px;">
    	<tr>
    		<td style="text-align: center;"><h2>답글</h2></td>
    	</tr>
    	<tr>
    		<td><textarea readonly="readonly" maxlength="2048" class="tarea"><%=rs.getString(7) %></textarea>
    </table>
	</div>	      		
      <%} %>	
		   	<div class="btn_wrap">
      		<input type="button" value="목록" class="btn_col2" onclick="location.href='customMyQuestion.jsp'" >
      		</div>
