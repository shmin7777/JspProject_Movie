...
<script>
  $(document).ready(function(){
	...
	<%
		...
		String sql1 = "select * from noticeList where no=?";
		...
		String date = rs1.getString(4).substring(0, 10);
		int cnt = rs1.getInt(5);
		
		String sql2 = "update noticeList set readCount=? where no=?";
	...
	%>
      ...
      <hr style="border: solid 1px lightgray;"><br>
      		...
      		<ul class="tab_wrap">
      			...
      			<a href="customOneByOne.jsp"><li><img class="noti" src="images/obo.png">1대1문의</li></a>
      			<a href="customMyQuestion.jsp"><li><img class="noti" src="images/myq.png">나의 문의 내역</li></a>
      		</ul>
      		<br><br><br><br>
      		<%=title %><br><br>
      		<table class="noticeView" cellspacing="0">
      			<thead>
	      			<tr>
	      				<th>등록일&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<%=date %></th><th>조회수&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<%=cnt+1 %></th>
	      			</tr>	
      			</thead>
      				<tr>
      		...
      		<input type="button" value="목록" style="padding: 13px 30px;background: white;color: #524c4a	;border-radius: 10px; border: 2px solid #524c4a; cursor: pointer;"onclick="location.href='customNotice.jsp'" class="btnNoticeList">
     		</div>
      </div>
