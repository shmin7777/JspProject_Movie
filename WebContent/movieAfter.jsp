      ...
      $('.close_b').click(function(){
        $('.all_menu').removeClass('on');
         ...
         if(selected.equals("s1")){
            sql="select * from movieAfter order by premiere";
            checked[0]="class=checkActive";
            checked[1]="";
         }else if(selected.equals("s2")){
            sql="select * from movieAfter order by love desc";
            checked[0]="";
            checked[1]="class=checkActive";
         }
         ...
         <div class="sang">
          ...
          <div> <h2 class="tkddud">상영 예정작</h2>
          </div>
            <div class="gaebong" style="text-align: right;position: relative;right: 119px;">
            <a href="movieAfter.jsp?selected=s1" style="font-family: sans-serif;" <%= checked[0]%>>개봉일순</a> 
            <span style="color: #C0BCC0;">|</span>
             <a href="movieAfter.jsp?selected=s2" style="font-family: sans-serif;"<%= checked[1]%>>보고싶어요순</a>
             </div>
         </div><br>
          <div class="sangmo" style="text-align: left;width: 1200px;margin: auto;margin-top: 30px;">
         <%
            ...
            while(rs.next()){
                 ...
                 Date d1 = new Date();
                   ...
                   d1 = sdf.parse(premiere);
                  d2= sdf.parse(sdf.format(d2));
                  long calDate=d2.getTime()-d1.getTime();
                 ...
                 if(compare >= 0){
                    %>
                    <div class="movie hidden movieAfter">
                     
                     <div><%-- <a href="movieAfterDetail.jsp?movieID=<%=movieID%>"> --%><img class="movieBord" alt="" src="movieAfterImages/<%=img%>" width="217px" height="312px"><!-- </a> --></div>
                     <div class="movieText"><h3><%=movieTitle %></h3>
                        <span style="font-size: 13px;font-family: sans-serif;">개봉날짜: <%=premiere %></span>
                        <!-- <span style="font-size: 14px;color: red; font-family: sans-serif;">D-<%=calDateDays%></span> -->
                     </div>
                     <div style="width: 80%;margin-top: 10px;">
                        <div class="loveMovie" onclick="location.href='movieAfterLoveAction.jsp?movieID=<%=movieID%>'">♡ <%=love %></div> 
                        <div style="width: 48%;display: inline-block;padding: 6px 0;background:#959191;color:#fff; text-align: center;"><span style="font-size: 15px;color:white; font-family: sans-serif;">D-<%=calDateDays%></span></div> 
                     </div>
                  </div>
              <%   
                 }
