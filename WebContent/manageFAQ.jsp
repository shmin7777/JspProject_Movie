...
<tr height="100" >
	<td align="center" colspan="3">
		<font size="8" color="gray"> <a href="#">FAQ</a> </font>
	</td>
</tr>
<tr bgcolor="pink">
	<td>분류</td><td>제목</td><td>수정</td>
</tr>
<%
...
%>
<tr>
	<td><%=rs.getString(2) %></td><td><%=rs.getString(3) %></td><td><a href="manageUpdateFAQ.jsp?no=<%=rs.getInt(1)%>">YES</a></td>
</tr>
<%		}
	}catch(Exception e){
		e.printStackTrace();
