...
<div style="height: 830px; overflow: auto;">
    ...
    <h2 style="text-align: center" ><%=rs.getString(3) %></h2><br>
        <table class="tbl_form" cellspacing="0" width="600px" border="1" style="margin: auto;">
      			<tr>
      				...
      				<div name="content" maxlength="2048" style="text-align:left; background-color: #F8F8F8;border-color:#DDD;padding: 10px;">
      					...
      					<br><br><br><img src="custom/<%=rs.getString(5) %>">
      					<%} %>
      				</div>
      				</td>
      			</tr>
    ...
    <form method="post" action="manageOneByOneRepleAction.jsp">
    <table class="tbl_form" cellspacing="0" width="600px" border="1" style="margin: auto;margin-top: 25px;">
    	<tr>
    		<td style="text-align: center;"><h2>답글달기</h2></td>
    	</tr>
    	<tr>
    		<td><textarea maxlength="2048" class="tarea" name="reple"></textarea>
    </table>
    
     <br><br>
     <div style="text-align: center;">
     <input type="submit" value="답변하기" style="padding: 13px 50px; margin-left: 10px;">
     <button style="padding: 13px 50px;" onclick="location.href='manageOneByOne.jsp'">목록</button>
     </div>
