...
%>
    ...
    <form method="post" action="manageOneByOne.jsp">
    <%
    	String noReple = request.getParameter("noReple");
    	if(noReple==null||noReple.equals("")){
    		noReple="";  
    	}
    %>	
...
<div style="height: 830px; overflow: auto;">
    <div class="container"><br><br>
        <table width="800" class="selectCurMovie" >
<tr height="100" >
	<td align="center" colspan="4">
		<font size="8" color="gray"> <a href="manageOneByOne.jsp">1대1문의</a> </font>
		<input type="checkBox" name="noReple" value="noReple">답변안된것만 보기
		<input type="submit" value="검색">
	</td>

</tr>
<tr bgcolor="pink">
	<td>제목</td><td>아이디</td><td>날짜</td><td>답변하기</td>
</tr>
<%
...
try {
	...
	if(noReple.equals("")){
		sql="select * from onebyone";
	}else{
		sql="select * from onebyone where reple is null";
	}
...
%>
<tr>
	<td><%=rs.getString(3) %></td><td><%=rs.getString(2) %></td><td><%=rs.getString(6).substring(0, 10) %></td>
	<td><%if(rs.getString(7)==null){ %><a href="manageOneByOneReple.jsp?no=<%=rs.getInt(1)%>">YES</a><%}else{%>답변완료 <%} %></td>
