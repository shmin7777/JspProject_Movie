...
<div class="login-wrapper" style="background: url(images/cutton.jpg) no-repeat;">
      <div class="loginbox" >
        <h1>아이디 찾기</h1> 
        <form action="findIDAction.jsp" method="post" name="newID">
          <label for="login" class="labelid">이름</label>
          <input type="text" id="loginid" name="name"><br/>
          <label for="loginpw" class="labelpw" >이메일</label>
          <input type="email" id="loginpw" name="email" onkeydown="onEnterSubmit1()">
   			<br>
   			<div class="search">
            	<a href="login.jsp" style="border-bottom: 1px dashed#999;">돌아가기</a>
            </div>	
          
          <div class="btnwrap">
            <a href="findPass.jsp">비밀번호 찾기</a>
            <input type="button" id="loginbtn" value="검색" onclick="findID()" >
