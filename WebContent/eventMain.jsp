...
<script>
  $(document).ready(function(){
     ...
     <div class="hall"><h2 class="gkfdls"></h2></div>
           <div class="page-util">
      ...
      <div class="container">
	      	  ...
	      	  <!-- <div><h2>이벤트</h2><hr style="border: 1px solid;width: 30%;margin:auto;margin-bottom: 50px;"></div> -->
	      
		      <div class="eve01" style="display: inline-block;margin-right: 70px;">
		       <a href="eventDetail01.jsp"><img src="images/br01.png" width="490px"></a>
		      </div>
		      <div class="eve01" style="display: inline-block;">
		       <a href="eventDetail02.jsp"><img src="images/gr01.png" width="490px"></a>
		       </div>
		       <br><br>
		       <div class="eve01" style="display: inline-block;margin-right: 70px;">
		       <a href="eventDetail03.jsp"><img src="images/event3.png" width="490px"></a>
		       </div>
		       <div class="eve01" style="display: inline-block;">
		       <a href="eventDetail04.jsp"><img src="images/event4.png" width="490px"></a>
		       </div>
	      </div><br>
	      <div align=center class="confoot">
	      <h3 > < </h3>
	      <h3 ><a href="#"> 1 </a></h3>
	      <h3 > > </h3>
	      </div>
