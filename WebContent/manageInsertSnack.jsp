...
%>
    ...
    <div class="movieInsert">
        <h1>스낵등록</h1>
        <form enctype="multipart/form-data" method="post" action="manageInsertSnackAction.jsp" name="insertSnack">
            <table border="1" width="700">
                <tr>
                	<td>스낵이름</td>
                	<td><input type="text" name="snackName"></td>
                </tr>
                <tr>
                	<td>스낵이미지</td>
                ...
                <tr>
                	<td>스낵설명</td>
                	<td><input type="text" name="snackInfo"></td>
                </tr>
                <tr>
                	<td>스낵종류</td>
                	<td>
                ...
                <tr>
                	<td>가격</td>
                	<td><input type="text" name="snackPrice"></td>
                </tr>
