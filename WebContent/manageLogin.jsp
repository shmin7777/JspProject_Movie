...
<script>
  $(document).ready(function(){
	...
	<div class="login-wrapper" style="background: url(images/cutton.jpg) no-repeat;">
      <div class="loginbox" style="height: 370px;">
        <h1 >관리자 로그인</h1><br>
        <form action="manageLoginAction.jsp" method="post" name="adminLog">
          <label for="login" class="labelid">아이디</label>
          <input type="text" id="loginid" name="id"><br/>
          <label for="loginpw" class="labelpw" >패스워드</label>
          <input type="password" id="loginpw" name="password" onkeydown="onEnterSubmit3()">

          <div class="btnwrap">
           
            <input type="button" id="loginbtn" value="로그인" onclick="loginCheck2()" >
