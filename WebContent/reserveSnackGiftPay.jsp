  ...
  $(document).ready(function(){
      ...
      $('.close_b').click(function(){
        $('.all_menu').removeClass('on');
        	...
        	String giftPhone = request.getParameter("giftPhone");
        	String message = request.getParameter("message");
        	String place = request.getParameter("place");
        	
        	String directNo = request.getParameter("directNo");
        	String directQty = request.getParameter("directQty");
    		...
    		Connection con=DriverManager.getConnection(dburl,dbid,dbpassword);
    			...
    			if(toID.equals("")){
    				PrintWriter script = response.getWriter();
            		script.println("<script>");
            		script.println("alert('받는 사람의 정보가 없습니다. 다시한번 확인해주세요.')");
        		...
        		int minusPrice = Integer.parseInt(request.getParameter("minusPrice"));
					...
					<div class="location">
						...
						<a href="reserveSnackGift.jsp">
							선물하기
												...
												<img alt="" src="images/bg-location.png" style="margin: 0 10px;">
						<a href="reserveSnackGiftPay.jsp">
							결제하기
						</a>
					</div>
				</div>
			...
			<div style="text-align: left;"><h2>상품결제 </h2></div><br>
         	...
         	<div style="margin-bottom: 10px;/* margin-top: 30px; */text-align: left;float: left;">* 고객님은 <%=userGrade %>등급으로<span style="color: red;"> <%=percent %>%</span> 만큼 할인됩니다.</div>
			...
			<div>
         	...
         	<form method="post" action="reserveSnackGiftPayAction.jsp" name="reserveSnack">
			...
			<script>
                   function changeRadio(){
             		...
             		<%-- <div style="text-align: left;display: inline;float: left;">* 고객님은 <%=userGrade %>등급으로 <%=percent %>% 만큼 할인됩니다.</div>
             		<div>
             			<input type="button" value="할인안내" onclick="location.href='reserveInfo.jsp'" class="btnReserveInfo" style="width: 100px;margin-left: 72px;">
             		</div> --%>
                   <div class="reservePayForm">
                   		...
                   		<div>
                   			...
                   			<div class="content open1" >MY 할인쿠폰	<span id="coupon"><%=coupon %></span>개
                   			  ...
                   			  <input type="button" value="-" onclick="minus();" id="cminus" style="padding:5 6;"> <span style="font-size: 14px; color: black;">* 쿠폰은 한 장당 5000원 입니다.</span>
                   			 </div>
                  ...
                  <!--  <div style="clear: both;"></div> -->
                   ...
                   <input type="hidden" name="directNo" value="<%=directNo %>">
					<input type="hidden" name="directQty" value="<%=directQty %>">
                   	<input type="button" value="결제하기" onclick="checkReserveValue();" class="btnReserveGo3" style="padding: 23px 109px;margin-right: 33px;">
                   </div>
