...
<script>
  $(document).ready(function(){
      ...
      <div class="loginbox" >
        <h1>비밀번호 찾기</h1> 
        <form action="findPassAction.jsp" method="post" name="newPass">
          <label for="login" class="labelid">아이디</label>
          <input type="text" id="loginid" name="id"><br/>
          <label for="loginpw" class="labelpw" >전화번호</label>
          <select name="phone1">
         ...
         <input type="text" name="phone2" size="4"> - <input type="text" name="phone3" size="4" onkeydown="onEnterSubmit2()">
          ...
          <div class="btnwrap">
            ...
            <input type="button" id="loginbtn" value="검색" onclick="findPass()">
